    ...
    <div class="nav-header">
      <slot name="nav-header">
        <RouterLink to="/" class="app-logo app-title-wrapper">
          ...
          <VNodeRenderer :nodes="config.app.logo" v-if="!company.image_logo" />
          <!-- <div style="width: 100px!important;"> -->
            <VAvatar class="ml-13" :image="company.image_logo" size="100" v-if="company.image_logo"/>
          <!-- </div> -->
...
.layout-content-width-boxed .layout-page-content {
  ...
  max-inline-size: 1642px !important;
}
